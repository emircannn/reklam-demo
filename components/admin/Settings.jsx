...
const Settings = () => {
  ...
  return (
    ...
    {settings.slice(0,1).map((setting) => (
        ...
        <input onChange={(e) => setShippingWage(e.target.value)} placeholder={setting.shippingWage} type="number" className="h-12 w-full border-2 border-primary outline-none px-4 peer"/>
        ...
        <div className='flex items-center justify-center w-full gap-4'>
        <input onChange={(e) => setDesignWage(e.target.value)} placeholder={setting.designWage} type="number" className="h-12 w-full border-2 border-primary outline-none px-4 peer"/>
        ...
        <div className='flex items-center justify-center w-full gap-4'>
        <input onChange={(e) => setFreeShipping(e.target.value)}  placeholder={setting.freeShipping} type="number" className="h-12 w-full border-2 border-primary outline-none px-4 peer"/>
        ...
        <div className='flex items-center justify-center w-full gap-4'>
        <input onChange={(e) => setMinwage(e.target.value)} placeholder={setting.minwage} type="number" className="h-12 w-full border-2 border-primary outline-none px-4 peer"/>
        ...
        <div className='flex items-center justify-center w-full gap-4'>
        <input onChange={(e) => setAddres(e.target.value)} placeholder={setting.address} type="text" className="h-12 w-full border-2 border-primary outline-none px-4 peer"/>
        ...
        <div className='flex items-center justify-center w-full gap-4'>
        <input onChange={(e) => setPhone(e.target.value)} placeholder={setting.phone} type="text" className="h-12 w-full border-2 border-primary outline-none px-4 peer"/>
        ...
        <div className='flex items-center justify-center w-full gap-4'>
        <input onChange={(e) => SetEmail(e.target.value)} placeholder={setting.email} type="email" className="h-12 w-full border-2 border-primary outline-none px-4 peer"/>
