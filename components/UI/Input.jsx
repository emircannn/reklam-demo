  ...
  return (
    <div className='w-full'>
        <label className='relative block cursor-text'>
            <input type={type} name={name} className={`h-10 w-full border-2 border-primary outline-none px-4 peer 
            ...
            duration-300 peer-focus:h-5 peer-focus:text-xs peer-focus:text-black/50 font-semibold
            peer-valid:h-5 peer-valid:text-xs peer-valid:text-black/50'>{placeholder}</span> }
