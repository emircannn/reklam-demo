      ...
      <div className='w-[90%] mx-auto py-6 flex items-center justify-between'>
        ...
        <nav className='max-md:hidden'>
          <ul className='flex items-center justify-center gap-4 font-medium'>
            <Link href='/'>
            <li className='cursor-pointer hover:text-primary max-2xl:text-sm duration-300'>Ana Sayfa</li>
            </Link>
            <Link href='/urunlerimiz'>
            <li className='cursor-pointer hover:text-primary max-2xl:text-sm duration-300'>Ürünlerimiz</li>
            </Link>
            <Link href='/hakkimizda'>
            <li className='cursor-pointer hover:text-primary max-2xl:text-sm duration-300'>Hakkımızda</li>
            </Link>
            <Link href='/iletisim'>
            <li className='cursor-pointer hover:text-primary max-2xl:text-sm duration-300'>İletişim</li>
            </Link>
