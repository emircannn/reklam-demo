        ...
        <Header/>
            <section className='min-h-[calc(100vh_-_349px)] w-[90%] mx-auto my-12'>
                ...
                <h1 className='font-bold text-primary tracking-wide text-4xl max-2xl:text-2xl uppercase'>İletişim</h1>
                        ...
                        <a href='tel:05525779332' className='text-slate-800 font-bold hover:text-primary duration-300 max-2xl:text-lg cursor-pointer text-xl uppercase'>0552 577 93 32</a>
                        </div>
                        <div className='flex items-center text-slate-800 font-bold gap-2 ml-2'>
                        <AiFillMail className='text-primary' size={30}/>
                        <a href='mailto:yasar.emircann@gmail.com' className='text-slate-800 font-bold hover:text-primary max-2xl:text-lg duration-300 cursor-pointer text-xl'>yasar.emircann@gmail.com</a>
                        </div>
